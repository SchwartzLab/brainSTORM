...
## Original run (P. occultum transcriptome)

```{r}
# setwd("/home/labs/schwartzlab/miguelg/github_repos/brainSTORM/")
# unlink("bam_Pa", recursive = TRUE) # Delete output dir
# rmTmpDir() # Delete tmp dir
tStart <- Sys.time()
# load_all()
```
...
**Resutls for Pseudouridine**

```{r}
rnaMod <- RNAmods_vec[1]
gridExtra::grid.arrange(ggList_Pa_Sc[[rnaMod]]$gg1, ggList_Pa_Sc[[rnaMod]]$gg2, ncol = 1)

```



## Run with actual P. abyssi genome
